...
class CommandCenterSelect(discord.ui.Select):
    ...
    '/giftcode "add giftcode here"'
            ...
            embed.description="The Hero Database is currently under construction.\n\nIn the future, this will be the place where you'll find everything you need to know about Heroes, Factions, Gear, Best Lineups and much more... 🐉"
            image="draco_underconstruction.png"
        elif choice=="Suggestions":
            embed.title="💡 Suggestions"
            embed.description="Share your ideas to help improve Draco and the Dragons Den community.\n\n**Command:** `/suggestion`"
            image="draco_idea.png"
        elif choice=="Appreciation":
            embed.title="❤️ Appreciation"
            embed.description="Show your appreciation if you like all the work I've put into this server.\n\n**Command:** `/appreciation`"
